...
class PlayerBox(Box):
    def __init__(self, mpris_player=None):
        ...
        self.title = Label(
            ...
            ellipsization="end",
            max_chars_width=1,
            style_classes=["vertical"] if vertical_mode else [],
        )
        self.album = Label(
            name="player-album",
            h_expand=True,
        ...
        self.play_pause = Button(
            name="player-btn",
            child=Label(
                name="player-btn-label", markup=icons.play, style_classes=["play-pause"]
            ),
    ...
    def _set_cover_image(self, image_path):
        ...
        def is_image(file_path):
            ...
            return (
                ...
                and os.path.splitext(file_path)[1].lower() in valid_extensions
            )
